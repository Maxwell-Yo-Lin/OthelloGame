...
class Spot:
    def __init__(self, center: point.Point, radius_frac: float, piece_color: str):
        '''
...
class SpotsState:
    ...
    def handle_click(self, click_point: point.Point,SPOT_RADIUS_FRAC, color) -> None:
        '''
        ...
        self._spots.append(Spot(click_point, SPOT_RADIUS_FRAC, color))

    def add_spot(self, click_point: point.Point,SPOT_RADIUS_FRAC, color) -> None:
        self._spots.append(Spot(click_point, SPOT_RADIUS_FRAC, color))
